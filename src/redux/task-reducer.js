...
let initialState= {
    todayTasks: [
        ...
        { task: "Implement importance functionality - Need Advice", id: '13', importance: 10, done: false },
        { task: "Chnage the importance on double click on color - Hold", id: '14', importance: 10, done: false },
        { task: "Scrool up and down fuctionality", id: '15', importance: 10, done: true },
        { task: "Implement drag-and drop func", id: '16', importance: 10, done: false },
      ],
    tomarowTask: [
        { task: "Implement drag-and drop func", id: '17', importance: 10, done: false },
